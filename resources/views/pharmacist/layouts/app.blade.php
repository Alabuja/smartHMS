        ...
        <div class="sidebar-left">
            ...
            <div class="sidebar-left-info">
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="active"><a href="{{ url('pharmacist/home') }}"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
                    <li><a href="{{ url('pharmacist/medicine_category') }}"><i class="fa fa-home"></i> <span>Medicine Category</span></a></li>

                    <li class="menu-list"><a href=""><i class="fa fa-book"></i> <span>Medicine </span></a>
                        <ul class="child-list">
                            <li><a href="{{ url('pharmacist/medicine') }}">Manage Medicines </a></li>
                            <li><a href="{{ url('pharmacist/medicine_sale') }}"> Medicine Sales</a></li>
                        </ul>
                    </li>
                    ...
                    <ul class="notification-menu">
                        ...
                        <li>
                            ...
                            <ul class="dropdown-menu dropdown-usermenu purple pull-right">
                                <li><a href="{{ url('pharmacist/profile') }}">  Profile</a></li>
                                <li>
