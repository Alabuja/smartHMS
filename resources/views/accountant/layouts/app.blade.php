        ...
        <div class="sidebar-left">
            ...
            <div class="sidebar-left-info">
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="active"><a href="{{ url('accountant/home') }}"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>

                    <li class="menu-list"><a href=""><i class="fa fa-book"></i> <span>Add Invoice</span></a>
                        <ul class="child-list">
                            <li><a href="{{ url('accountant/invoice_add') }}">Add Invoice </a></li>
                            <li><a href="{{ url('accountant/invoice_manage') }}">Manage Invoice</a></li>
                        </ul>
                    </li>
                    ...
                    <ul class="notification-menu">
                        ...
                        <li>
                            ...
                            <ul class="dropdown-menu dropdown-usermenu purple pull-right">
                                <li><a href="{{ url('accountant/profile') }}">  Profile</a></li>
                                <li>
