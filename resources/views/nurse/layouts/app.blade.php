        ...
        <div class="sidebar-left">
            ...
            <div class="sidebar-left-info">
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="active"><a href="{{ url('nurse/home') }}"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
                    <li><a href="{{ url('nurse/patient') }}"><i class="fa fa-home"></i> <span>Patients</span></a></li>

                    <li class="menu-list"><a href=""><i class="fa fa-book"></i> <span>Blood Bank</span></a>
                        <ul class="child-list">
                            <li><a href="{{ url('nurse/blood_bank') }}">Manage Blood Bank </a></li>
                            <li><a href="{{ url('nurse/blood_donor') }}"> Blood Donor</a></li>
                        </ul>
                    </li>

                    <li class="menu-list"><a href=""><i class="fa fa-file-text"></i> <span>Bed/Ward</span></a>
                        <ul class="child-list">
                            <li><a href="{{ url('nurse/bed') }}"> Manage Bed</a></li>
                            <li><a href="{{ url('nurse/bed_allotment') }}"> Bed Allotment</a></li>
