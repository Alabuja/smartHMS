                    ...
                    <ul class="notification-menu">
                        ...
                        <li>
                            <a href="javascript:;" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                                <img src="{{ Auth::guard('patient')->user()->avatar_url }}" alt="{{ Auth::guard('patient')->user()->name }}">{{ Auth::guard('patient')->user()->name }}
                                <span class=" fa fa-angle-down"></span>
                            </a>
                            <ul class="dropdown-menu dropdown-usermenu purple pull-right">
                                <li><a href="{{ url('patient/profile') }}">  Profile</a></li>
                                <li>
                                    <a href="{{ route('patient.logout') }}" onclick="event.preventDefault();
