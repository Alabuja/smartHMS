        ...
        <div class="sidebar-left">
            ...
            <div class="sidebar-left-info">
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="active"><a href="{{ url('laboratorist/home') }}"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
                    <li><a href="{{ url('laboratorist/blood_bank') }}"><i class="fa fa-home"></i> <span>Blood Bank</span></a></li>
                    <li><a href="{{ url('laboratorist/blood_donor') }}"><i class="fa fa-home"></i><span>Blood Donor</span></a></li>
                    ...
                    <ul class="notification-menu">
                        ...
                        <li>
                            ...
                            <ul class="dropdown-menu dropdown-usermenu purple pull-right">
                                <li><a href="{{ url('laboratorist/profile') }}">  Profile</a></li>
                                <li>
